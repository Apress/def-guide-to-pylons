...
_magic_number = 4
_modified_time = 1225983156.885793
_template_filename='/media/disk/Pylons Book/Code/chapter14/SimpleSite17/SimpleSite/simplesite/templates/derived/comment/edit.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u' comment:</p>\n')
        # SOURCE LINE 9
        __M_writer(escape(h.form_start(h.url_for(pageid=c.pageid, controller='comment', action='save',
