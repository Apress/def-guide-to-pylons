...
_magic_number = 4
_modified_time = 1225982963.9721301
_template_filename='/media/disk/Pylons Book/Code/chapter14/SimpleSite17/SimpleSite/simplesite/templates/derived/comment/new.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n')
        # SOURCE LINE 8
        __M_writer(escape(h.form_start(h.url_for(pageid=c.pageid, controller='comment', action='create'), method="post")))
        __M_writer(u'\n    ')
        # SOURCE LINE 9
