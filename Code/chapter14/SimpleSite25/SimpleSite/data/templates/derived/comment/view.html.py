...
_magic_number = 4
_modified_time = 1225983154.1417401
_template_filename='/media/disk/Pylons Book/Code/chapter14/SimpleSite17/SimpleSite/simplesite/templates/derived/comment/view.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'.</em></p>\n<p><a href="')
        # SOURCE LINE 9
        __M_writer(escape(h.url_for(controller='page', action='view', id=c.comment.pageid)))
