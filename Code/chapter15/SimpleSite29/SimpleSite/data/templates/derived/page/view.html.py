...
_magic_number = 4
_modified_time = 1226018099.610291
_template_filename='/media/disk/Pylons Book/Code/chapter15/SimpleSite29/SimpleSite/simplesite/templates/derived/page/view.html'
_template_uri='/derived/page/view.html'
_template_cache=cache.Cache(__name__, _modified_time)
_source_encoding='utf-8'
from webhelpers.html import escape
_exports = ['footer', 'menu', 'tags', 'heading', 'title']
